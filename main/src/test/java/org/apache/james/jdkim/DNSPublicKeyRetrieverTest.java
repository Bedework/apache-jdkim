...
public class DNSPublicKeyRetrieverTest extends TestCase {
    ...
    public void testKeyPair() throws PermFailException, TempFailException,
        ...
        PublicKeyRecord key = new DKIMVerifierImpl()
        ...
        PrivateKey privKey = DKIMSignerImpl.getPrivateKey(privateKeyPKCS8);
    ...
    public void testSignVerify() throws NoSuchAlgorithmException,
        ...
        DKIMSignerImpl signer = new DKIMSignerImpl(
        ...
        new DKIMVerifierImpl(mockPublicKeyRecordRetriever)
