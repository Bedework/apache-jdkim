 ...
 *
 */
public class IscheduleDKIMSignerImpl extends DKIMSignerImpl
        implements IscheduleDKIMSigner {
    public IscheduleDKIMSignerImpl(final PrivateKey privateKey) {
    ...
    public IscheduleDKIMSignerImpl(final String signatureRecordTemplate,
    		final PrivateKey privateKey) {
        super(signatureRecordTemplate, privateKey);
    }
