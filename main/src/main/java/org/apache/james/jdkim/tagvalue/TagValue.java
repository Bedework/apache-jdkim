...
public class TagValue {
    ...
    protected boolean containsTag(final String tag) {
        return tagValues.containsKey(tag);
    }

    protected CharSequence trimFWS(final CharSequence data, int tStart, int tStop,
            final boolean trimWSP) {
        if (debug) {
        	debugMsg("1[" + data + "]" + tStart + "|" + tStop + "="
    ...
    private CharSequence trimWSP(final CharSequence data, int vStart, int vStop) {
        if (vStop < (vStart - 1)) {
    ...
    public TagValue(final String data) {
     ...
     */
    protected void parse(final String data) {
    ...
    protected CharSequence getValue(final String key) {
    ...
    protected void setValue(final String tag, final String value) {
        stringRepresentation = null;
        tagValues.put(tag, value);
    }


    protected CharSequence getDefault(final String key) {
    ...
    protected List<CharSequence> stringToColonSeparatedList(final String h, final Pattern pattern) {
    ...
    protected boolean isInListCaseInsensitive(final CharSequence hash, final List<CharSequence> hashes) {
